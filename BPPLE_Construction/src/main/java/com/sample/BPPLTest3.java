...
public class BPPLTest3 extends JbpmJUnitBaseTestCase{
	...
	public void test() {
		try {
            ...
            ProcessInstance processInstance = kSession.startProcess("defaultPackage.ConstructionPlanReferenceVariant", params);
            ...
            String expectedMessage = "Executing Examine NCP";
