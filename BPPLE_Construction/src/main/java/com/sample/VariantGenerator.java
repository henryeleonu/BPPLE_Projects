...
public class VariantGenerator {
	...
	public void generateVariant() {
		Node currentItem;
		String referenceProcessFilePath = "C:\\jBPM\\jbpm-installer-7.3.0.Final\\workspace\\BPPLE_Construction\\src\\main\\resources\\process\\ConstructionPlanReference.bpmn2";
		String attributeName = "name";
		String contextInfoXMLFilePath = "C:\\jBPM\\jbpm-installer-7.3.0.Final\\workspace\\BPPLE_Construction\\src\\main\\resources\\data\\ContextInfo.xml";
		String variantFilePath = "C:\\jBPM\\jbpm-installer-7.3.0.Final\\workspace\\BPPLE_Construction\\src\\main\\resources\\process\\ConstructionPlanVariant1.bpmn2";
		...
		for (int i = 0; i < listOfSubProcesses.getLength(); i++)
        {
            ...
            if (fragFilePath != null && !fragFilePath.isEmpty()) {
        		...
        		//insert fragment into SubProcess				
        		//String attributeName = "id"; 
        		//String attributeValue = "SubProcess_1"; 
        		...
        		//insert fragment diagram into BPMNPlane
        		//String diXPathexp2 = "/bpmn2:definitions/bpmn2:process/bpmn2:subProcess";
