...
public class BPPLTest3 extends JbpmJUnitBaseTestCase{
	...
	public void test() {
		try {
        	...
        	String contextInfoPath = "C:\\jBPM\\jbpm-installer-7.3.0.Final\\workspace\\BPPLE_Invoice\\src\\main\\resources\\data\\ContextInfo.xml";
            ...
            ProcessInstance processInstance = kSession.startProcess("defaultPackage.InvoiceReferenceVariant", params);
            ...
            //System.out.println("message from fragment ==" + message);
            assertProcessInstanceCompleted(processInstance.getId(), kSession);
            String expectedMessage = "Evaluating Receipt Settlement";
