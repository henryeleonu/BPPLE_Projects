...
public class ContextInfo {
	...
	public String getContextValueByKey(String key) {
		...
		//System.out.println("all text " + contextNode.getTextContent());
		...
		//System.out.println("text 2 " + valueNode.getNodeValue());
		//String str = valueNode.getNodeValue();
		//System.out.println("the length is: " + str.length() + "" + str);
		return str.trim();
		
		//return contextValue.getNodeValue();
		//return contextValue.getTextContent();
